            ...
            <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Tambahkan aturan perhitungan poin berdasarkan program, produk, jenis transaksi, dan penerima poin.
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="point_program_id"
                                ...
                                @foreach ($programs as $program)
                                    <option value="{{ $program->id }}" {{ old('point_program_id') == $program->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="transaction_type"
                                ...
                                <option value="customer_purchase" {{ old('transaction_type') === 'customer_purchase' ? 'selected' : '' }}>
                                    Konsumen beli di Toko/Kios
                                </option>
                                <option value="store_purchase" {{ old('transaction_type') === 'store_purchase' ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="recipient_type"
                                ...
                                <option value="customer" {{ old('recipient_type') === 'customer' ? 'selected' : '' }}>
                                    Konsumen
                                </option>
                                <option value="store" {{ old('recipient_type') === 'store' ? 'selected' : '' }}>
                                    Toko/Kios
                                </option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="point_per_item" value="{{ old('point_per_item', 0) }}"
                                   class="mt-1 w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   min="0"
                                   required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="multiplier" value="{{ old('multiplier', 1) }}"
                                   class="mt-1 w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   step="0.01"
                                   min="0"
                                   required>
