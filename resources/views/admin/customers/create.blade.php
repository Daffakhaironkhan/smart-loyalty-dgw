            ...
            <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Tambahkan data konsumen baru agar dapat terdaftar sebagai member dan menerima poin dari transaksi pembelian.
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-1">
                                Diisi jika konsumen akan memiliki akun login.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="membership_level" value="{{ old('membership_level', 'Silver') }}"
                                   class="mt-1 w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="registered_by_store_id"
                                ...
                                @foreach ($stores as $store)
                                    <option value="{{ $store->id }}" {{ old('registered_by_store_id') == $store->id ? 'selected' : '' }}>
                                        {{ $store->store_name }}
                                    </option>
                                @endforeach
                            </select>
