        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Lihat detail data konsumen, informasi member, total poin, dan riwayat keterhubungan dengan Toko/Kios.
                    </p>
                </div>
            ...
            <div class="bg-white shadow-sm rounded-2xl border border-slate-200 p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <p class="text-sm text-slate-500">Kode Member</p>
                        <p class="font-semibold">{{ $customer->member_code }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="font-semibold">{{ $customer->birth_date ?? '-' }}</p>
                    </div>
                    ...
                    <div>
                        <p class="text-sm text-slate-500">Membership Level</p>
                        <p class="font-semibold">{{ $customer->membership_level ?? '-' }}</p>
                    </div>

                    <div>
                        <p class="text-sm text-slate-500">Toko/Kios Pendaftar</p>
                        <p class="font-semibold">{{ $customer->registeredByStore->store_name ?? '-' }}</p>
                    </div>

                    <div>
                        <p class="text-sm text-slate-500">Total Poin</p>
                        <p class="font-semibold">{{ number_format($customer->total_points) }}</p>
                    </div>
