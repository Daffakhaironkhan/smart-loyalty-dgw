            ...
            <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Tambahkan reward baru yang dapat ditukarkan oleh Konsumen, Toko/Kios, atau keduanya sesuai kebutuhan poin.
                    </p>
                </div>
                ...
                <form action="{{ route('admin.rewards.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="reward_code" value="{{ old('reward_code') }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="required_points" value="{{ old('required_points', 0) }}"
                                   class="mt-1 w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   min="0"
                                   required>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="redeemable_by"
                                    class="mt-1 w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    required>
                                <option value="customer" {{ old('redeemable_by') === 'customer' ? 'selected' : '' }}>
                                    Konsumen
                                </option>
                                <option value="store" {{ old('redeemable_by') === 'store' ? 'selected' : '' }}>
                                    Toko/Kios
                                </option>
                                <option value="both" {{ old('redeemable_by') === 'both' ? 'selected' : '' }}>
                                    Konsumen & Toko/Kios
                                </option>
                            </select>
                        </div>
